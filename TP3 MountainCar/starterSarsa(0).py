...
class Agent():
    ...
    def __init__(self):
        ...
        self.eps = 0.1       # set epsilon for epsilon greedy action
    ...
    def update(self, next_state, reward):
        ...
        if self.first_visit == False :
            ...
            self.delta = reward + self.gamma * self.Q[self.action+1] - self.previous_Q[self.previous_action+1]
            self.W[self.action+1] += self.alpha * self.delta * self.previous_phi
        else :
